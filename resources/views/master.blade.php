<?php $CDN_URL = 'http://static.youngchina.review/'; ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
    <title>AdminYCA</title>
    <!-- Bootstrap 3.3.2 -->
    ...
    <!-- Ionicons 2.0.0 -->
    <link href="http://cdn.bootcss.com/ionicons/2.0.0/css/ionicons.min.css" rel="stylesheet" type="text/css" />
    <!-- Theme style -->
